...
import com.bbinkconnect.bbinktattoo.AddStoryActivity;
import com.bbinkconnect.bbinktattoo.R;
import com.bbinkconnect.bbinktattoo.StoryActivity;
...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        final ImageView story_photo;
        final ImageView story_plus;
        final ImageView story_photo_seen;
        final TextView story_username;
        final TextView addstory_text;
