...
import com.bbinkconnect.bbinktattoo.adapter.CommentAdapter;
import com.bbinkconnect.bbinktattoo.model.Comment;
    ...
    private void getImage(){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Glide.with(getApplicationContext()).load(Objects.requireNonNull(user).getImageurl()).into(image_profile);
            }
